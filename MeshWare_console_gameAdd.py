...
class Build_Buttons:
    ...
    def grid_buttons(self=0):
        ...
        canvas = Canvas(ttpw_subtaskpane, bd=0, highlightthickness=0,
                        background = 'gold', width = 200, height = 200)
        canvas.pack(fill=BOTH, expand=TRUE)
        canvas.config(scrollregion=canvas.bbox(0, 0, 1000, 1000))
...
##                print(defcon)
        ...
        vscrollbar = Scrollbar(ttpw_subtaskpane, orient=VERTICAL)
    ...
    def pack_subbuttons(self=0):
        ...
        # create a canvas object and a vertical scrollbar for scrolling it
        vscrollbar = Scrollbar(ttpw_taskpane, orient=VERTICAL)
        vscrollbar.pack(fill=Y, side=RIGHT, expand=FALSE)
        canvas = Canvas(ttpw_taskpane, bd=0, highlightthickness=0,
...
##    ttpw_canvas = Canvas(root, width=100, height=100,
##           borderwidth=0,
##           highlightthickness=0,
##           background='gold'
##          )
##    scrollbar = Scrollbar(ttpw_canvas)
