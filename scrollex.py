...
##        self.mylist = Listbox(self.scrollwindow)
##        for line in range(100):
##           self.mylist.insert(END, "This is line number " + str(line))
##
##        self.mylist.grid(column = 0, row = 0, sticky = 'nsew')
        
##        for line in range(100):
##           button = ttk.Button(self.scrollwindow,
##                    text = ("This is button number " + str(line)),
##                    style = 'grey.TButton')
##           button.grid(column = 0, row = line, sticky = 'nsew')
